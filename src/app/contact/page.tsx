          ...
          <form onSubmit={handleFormSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                required
                className="mt-1 p-3 w-full border rounded-md focus:outline-none focus:ring focus:border-primary bg-transparent border-black dark:border-white dark:text-white text-black"
              />
            </div>
            ...
            <div>
              ...
              <div className="mt-1 space-x-4">
                <select
                  ...
                  required
                  className="p-3 w-full border rounded-md focus:outline-none focus:ring focus:border-primary dark:bg-black bg-white dark:text-white text-black bg-transparent appearance-none"
                >
                  <option value="">Select a reason</option>
                  <option value="comments_feedback">
                    Comments and feedback
                  </option>
                  <option value="report_problem">Report a problem</option>
                  <option value="dmca">DMCA takedown request</option>
                  <option value="developer_support">
            ...
            <div className="text-center">
              <button
                type="submit"
                className={`mt-1 p-3 w-full border rounded-md focus:outline-none focus:ring focus:border-primary font-bold ${
                  formValid
                    ? "bg-primary text-black"
                    : "cursor-not-allowed bg-transparent border-black dark:border-white dark:text-white text-black"
                }`}
