    ...
    <div className={`h-fit flex ${gap} py-8 justify-center`}>
      <Tooltip showArrow={true} content="Instagram">
        <Link target="_blank" href="https://www.instagram.com/alightmotion">
          <FaInstagram size={20} className="hover:scale-125 transition-all text-black dark:text-white" />
        </Link>
      </Tooltip>
      ...
      <Tooltip showArrow={true} content="Twitter">
        <Link target="_blank" href="https://twitter.com/alightcreative">
          <RiTwitterXFill
            size={20}
            className="hover:scale-125 transition-all text-black dark:text-white"
          />
        </Link>
      </Tooltip>
      ...
      <Tooltip showArrow={true} content="Youtube">
        <Link target="_blank" href="https://youtube.com/alightmotion">
          <SlSocialYoutube
            size={20}
            className="hover:scale-125 transition-all w-8 text-black dark:text-white"
          />
        </Link>
      </Tooltip>
    </div>
